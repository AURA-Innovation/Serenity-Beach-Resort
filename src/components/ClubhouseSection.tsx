...
const CLUBHOUSE_IMAGES = [
  {
    src: "https://serenityabaco.com/wp-content/uploads/2022/09/360.400-1024x658.jpg",
    alt: "Clubhouse ocean view from the clubhouse deck",
  },
  {
    src: "https://serenityabaco.com/wp-content/uploads/2023/01/Bahamas-Clubhouse-.png",
    alt: "Clubhouse exterior showcasing pool and dining areas",
  },
];
